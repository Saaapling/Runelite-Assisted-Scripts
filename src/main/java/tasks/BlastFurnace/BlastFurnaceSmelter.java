...
public class BlastFurnaceSmelter extends InteractionTask {
    ...
    private void populate_actions(){
        ...
        actions.put("Move to Belt", new MouseLeftClickAction(mouse, belt_bounds, 6500, "Move to Belt"));
        actions.put("Mouseover Coal Bag", new MouseMoveAction(mouse, Offsets.get_inventory_coordinate(1,1), 15, 500, "Mouseover Coal Bag"));
